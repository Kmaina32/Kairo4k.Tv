...
const AddPlaylistModal = ({ onClose, onSuccess, initialData }: AddPlaylistModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="w-full max-w-md bg-[#0f172a] border border-white/10 rounded-2xl p-6 shadow-2xl relative overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                {/* Background Glow */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 mt-8">
                        ...
                        >
                            {loading ? 'Saving...' : initialData ? 'Update Source' : 'Add Source'}
                        </button>
                    </div>
                </form>
            </div>
