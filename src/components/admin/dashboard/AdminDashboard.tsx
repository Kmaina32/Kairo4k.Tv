...
import NexusChat from '../../viewer/ui/NexusChat';
import { supabase } from '../../../services/supabaseClient';
import AddPlaylistModal from '../playlists/AddPlaylistModal';
import MediaModal from '../content/AddMediaModal';
import MediaUploadPanel from '../content/MediaUploadPanel';
import StorageAnalytics from '../storage/StorageAnalytics';
import R2ImageGallery from '../content/R2ImageGallery';
import CommandDeck from './CommandDeck';
import AdminGovernance from '../governance/AdminGovernance';

import AdManager from '../ads/AdManager';
import VirtualChannelManager from '../channels/VirtualChannelManager';
import LiveStreamManager from '../channels/LiveStreamManager';
import SeriesManager from '../series/SeriesManager';
import RemoteDownloader from '../downloads/RemoteDownloader';
            ...
            <main className="flex-1 overflow-y-auto no-scrollbar relative p-3 md:p-8 lg:p-12 pb-28 lg:pb-12 pt-24 lg:pt-12">
                <div className={`mx-auto pb-8 lg:pb-0 ${adminView === 'broadcast' ? 'max-w-none' : 'max-w-7xl'}`}>
                    ...
                    {adminView === 'live-monitor' && (
                        <div className="animate-in fade-in duration-500 overflow-visible relative z-10">
                            <LiveStreamManager />
                        </div>
                    )}
